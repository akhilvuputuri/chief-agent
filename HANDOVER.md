...
Scheduled independent agent routines are implemented as a candidate for issue #56. Read [the extension contract and migration runbook](docs/scheduled-routines.md) before adding domain schedules; existing reminders remain separate.

...
Candidate v0.3.10: persistent preparation evidence chains on `feature/preparation-provenance`; [contract](docs/preparation.md). Adds migration 015 and its reviewed operator rollout. Existing data and paused tasks are preserved. Independent review, checks and deployment are pending; this is not a shipped-state claim.

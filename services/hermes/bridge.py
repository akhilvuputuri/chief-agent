...
MAX_BODY = 1_000_000
OPERATIONS = ["job_save", "job_list", "job_update", "job_analyze", "job_delete", "memory_set", "memory_list", "web_search", "web_read", "gmail_search", "gmail_read", "prep_save", "prep_list", "prep_task_save", "sheet_sync"]
SCHEMA = {

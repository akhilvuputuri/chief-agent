...
spec = importlib.util.spec_from_file_location(
    'deploy_parcels', pathlib.Path(__file__).with_name('deploy-parcels.py'))
...
class ParcelsRolloutTests(unittest.TestCase):
    ...
    def scenario(self, *, running=0, pending=0, baseline=None, requested_sha=SHA,
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            original = {
                ...
                'db/018_watchlist.sql': '-- original steering migration\n',
            }
            ...
            commands, statements = [], []
            database = {'migration19': False, 'tasks': [('existing-task', [])]}
            ...
            with patch.object(release, 'LIVE', live), \
                    ...
                    patch.object(sys, 'argv', ['deploy-parcels.py', str(archive_path), requested_sha]), \
    ...
    def test_running_work_and_pending_parcels_refuse_before_stop(self):

...
A blocked target need not block unrelated targets. Mark any steps that depend on a missing answer as blocked too; leave only independently runnable work pending. The runtime continues while pending work remains and pauses when all remaining work is blocked or the pass budget is reached.

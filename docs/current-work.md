...
In progress: [issue #64](https://github.com/akhilvuputuri/companion-agent/issues/64), on-demand parcel persistence and selected-email extraction. [Contract](parcels.md), [migration 019 rollout](parcel-rollout.md), [journal](journey/25-delivery-tracker.md). Pending final checks, independent review and operator rollout. No unsolicited email polling or carrier integration.

...
Released [v0.3.11](https://github.com/akhilvuputuri/companion-agent/releases/tag/v0.3.11) at `9c71f61d3578ae5718804b56aa281ee469d38396` ([PR #51](https://github.com/akhilvuputuri/companion-agent/pull/51)): NLB catalogue availability with the Lucky Day verdict rule, a pinned-route paced client and a CI boundary test; app-only. Owner acceptance from the phone is pending. Next: Phase 2 on `feature/library-account` (migration 016, encrypted identity, phone linking, shelf; operator-released), then approved writes and the hold-ready watcher. Plan: [issue #41](https://github.com/akhilvuputuri/companion-agent/issues/41); behaviour: [library](library.md); journal: [22](journey/22-library-assistant.md).

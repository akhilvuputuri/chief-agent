...
Candidate [PR #66](https://github.com/akhilvuputuri/companion-agent/pull/66) implements [issue #64](https://github.com/akhilvuputuri/companion-agent/issues/64), on-demand parcel persistence and selected-email extraction. [Contract](parcels.md), [migration 019 rollout](parcel-rollout.md), [journal](journey/25-delivery-tracker.md). Local check/build/format passed on 20 September (320 application + 2 script tests); independent Ultra review approved implementation head `71e866a0cfa821e6761546b2567ef835c8e4dcc1`. Consult the PR for final documentation-head approval. Operator rollout remains pending. UI acceptance is blocked by unavailable test Telegram/runtime/Gmail access. No unsolicited email polling or carrier integration.

Released scheduled routine foundation: [v0.3.15](https://github.com/akhilvuputuri/companion-agent/releases/tag/v0.3.15), issue #56, PRs #58/#59, migration 017. Operator rollout verified `c1f8e7088676d4ee3d041993d5e08412e4c73a70` healthy on 20 September 2026. Future domain agents should reuse the [contract/runbook](scheduled-routines.md). No live routine was created during deployment.

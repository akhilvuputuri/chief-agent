...
A future agent can change the policy value to a verified model ID in its own PR. The later switch and its release are recorded below; they were not part of the foundation release.

### Follow-up — 24 September 2026: GPT-6 Sol pin and restored automatic release

[PR #88](https://github.com/akhilvuputuri/chief-agent/pull/88) pinned `openai/gpt-6-sol` in the bundled policy and merged as `2240fe1b3d868871b393874dc82776e122849da2`. Its first main check could not start while GitHub Actions reported an account payment/spending-limit block. After the repository became public, the [automatic release](https://github.com/akhilvuputuri/chief-agent/actions/runs/35898129290) completed successfully for that exact SHA; the exact-commit release receipt reports deployment and startup health. The later documentation merge `4db377df1743cafe75e07ba22d288da1945248a4` contains the same model policy and also passed [main checks](https://github.com/akhilvuputuri/chief-agent/actions/runs/35898242145) and [automatic release](https://github.com/akhilvuputuri/chief-agent/actions/runs/35898616558). No paid model call was made after release, so the live provider path, price-filter eligibility and response behavior remain unverified. The v0.3.24 tag was not moved to these later commits.

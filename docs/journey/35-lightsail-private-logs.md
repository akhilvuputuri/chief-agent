...
| Approvals, memory, skills, canvases | Present                                      | Byte-identical tables                                                                                                                                                                                                                                                                                                                                       | Approvals: one live owner-approved Calendar event (see the Calendar row). Memory, skills and canvases: behaviour covered by fixture tests, with no live exercise.                                                             |
